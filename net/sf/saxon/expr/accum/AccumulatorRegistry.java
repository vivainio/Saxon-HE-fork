...
public class AccumulatorRegistry {
    ...
    protected Map<StructuredQName, Accumulator> accumulatorsByName = new ConcurrentHashMap<>();
     ...
     * @param styleElement the element on which the use-accumulators attribute appears
