 ...
 * a specified predicate, until it finds one that doesn't.
 * It does not change the values of any variables in the tuple stream.
 */
public class WhileClausePull extends TuplePull {
    ...
    public WhileClausePull(TuplePull base, BooleanEvaluator predicate) {
        this.base = base;
