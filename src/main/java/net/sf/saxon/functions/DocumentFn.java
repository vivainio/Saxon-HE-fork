        ...
        try {
            ...
            if (sourceIsTree(source)) {
                ...
                try {
                    ...
                    if (err.getErrorCodeQName() == null || err.hasErrorCode("SXXP0003")) {
 ...
 *                    such as strip-space)
    ...
    public static void sendDoc(String href,
        ...
        try {
            ...
            throw e.maybeWithLocation(locator)
                    .maybeWithErrorCode("FODC0002")
                    .replacingErrorCode("SXXP0003", "FODC0002");
        }
    }
