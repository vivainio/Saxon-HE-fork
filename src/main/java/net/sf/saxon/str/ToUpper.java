...
public class ToUpper {
    ...
    private final static IntRangeToIntMap ranges = new IntRangeToIntMap(678);
    private final static IntHashMap<String> specials = new IntHashMap<>(102);
    ...
    private static void init() {
        ...
        range(1377, 1414, -48);
        special(1415, "\u0535\u0552");
        range(4304, 4346, 3008);
        range(4349, 4351, 3008);
        range(5112, 5117, -8);
        single(7296, -6254);
        single(7297, -6253);
        single(7298, -6244);
        range(7299, 7300, -6242);
        single(7301, -6243);
        single(7302, -6236);
        single(7303, -6181);
        single(7304, 35266);
        ...
        range(66776, 66811, -40);
        range(66967, 66977, -39);
        range(66979, 66993, -39);
        range(66995, 67001, -39);
        range(67003, 67004, -39);
        range(68800, 68850, -64);
        range(71872, 71903, -32);
        range(93792, 93823, -32);
        range(125218, 125251, -34);
