...
public class ToLower {
    ...
    private final static IntRangeToIntMap ranges = new IntRangeToIntMap(667);
    private final static IntHashMap<String> specials = new IntHashMap<>(1);
    ...
    private static void init() {
        ...
        single(4295, 7264);
        single(4301, 7264);
        range(5024, 5103, 38864);
        range(5104, 5109, 8);
        range(7312, 7354, -3008);
        range(7357, 7359, -3008);
        single(7680, 1);
        single(7682, 1);
        single(7684, 1);
        single(7686, 1);
        ...
        range(66736, 66771, 40);
        range(66928, 66938, 39);
        range(66940, 66954, 39);
        range(66956, 66962, 39);
        range(66964, 66965, 39);
        range(68736, 68786, 64);
        range(71840, 71871, 32);
        range(93760, 93791, 32);
        range(125184, 125217, 34);
