 ...
 * type is jnode().
 */
public final class JNodeCoercionPlan extends CoercionPlan {

    public final static JNodeCoercionPlan INSTANCE = new JNodeCoercionPlan();

    public static JNodeCoercionPlan getInstance() {
        return INSTANCE;
    }
