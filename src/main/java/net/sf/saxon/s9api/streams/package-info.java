...
/**
 * <p>This package (introduced in Saxon 9.9) provides methods to manipulate XDM values using Java 8 streams.
 * It provides an alternative to XPath navigation of XDM trees, avoiding the high parsing cost and poor
 * compile-time diagnostics of XPath expressions, while being a much higher-level interface
 * than DOM-style navigation from node to node.</p>
 ...
 * <code>XdmItem</code> is an abstract class; its concrete subclasses include {@link net.sf.saxon.s9api.XdmNode} for
 ...
 * the standard Java 8 {@link java.util.stream.Stream} class; it does so by wrapping a standard
 ...
 * since a <code>Step</code> is just a Java 8 <code>Function</code>, and an <code>XdmStream</code> is just a
 * Java 8 <code>Stream</code>,
 ...
 * The predicate may be any Java 8 {@link java.util.function.Predicate}, but the class
