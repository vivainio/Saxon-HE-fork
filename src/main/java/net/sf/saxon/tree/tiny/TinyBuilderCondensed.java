...
public class TinyBuilderCondensed extends TinyBuilder {
    ...
    // "It is therefore inappropriate to use arbitrary <code>CharSequence</code> instances as elements in a set or as keys in
...
//                CodePoints chars = TinyTextImpl.getStringValue(tree, last);
//                // We rely on all relevant implementations of UnicodeString having compatible hashcodes (but if they
